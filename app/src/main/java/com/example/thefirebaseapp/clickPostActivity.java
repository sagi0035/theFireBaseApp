...
public class clickPostActivity extends AppCompatActivity {
    ...
    private String downloadUrlAgain;
    private Uri theimageUri;
    private CircleImageView theOther;
    private StorageReference postImagesReferenceAgain;
                                    ...
                                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                        filePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                            ...
                                            public void onSuccess(Uri uri) {
                                                // so we prevent the sendUserMainActivity from executing in the case of the image being clicked
                                                allower = false;
